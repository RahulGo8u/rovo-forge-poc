...
CatalogName = Literal["delivery-methods", "file-types", "email-types"]
...
PositiveId = Annotated[int, Path(ge=1, le=2_147_483_647, description="Positive integer identifier")]
